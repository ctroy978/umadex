...
import VocabularyUnlockModal from './VocabularyUnlockModal';

interface VocabularyTestLockoutModalProps {
  isOpen: boolean;
...
export default function VocabularyTestLockoutModal({ 
  isOpen, 
  testAttemptId, 
  onContactTeacher, 
  onUnlockSuccess 
}: VocabularyTestLockoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          <div className="bg-red-50 p-8 text-center">
            ...
            <div className="text-red-700 space-y-3">
              <p>Your vocabulary test has been locked because you left the test page twice.</p>
      ...
      {/* Vocabulary Unlock Modal */}
      {testAttemptId && (
        <VocabularyUnlockModal
