...
import UnlockTestModal from './UnlockTestModal';

interface TestLockoutModalProps {
  isOpen: boolean;
...
export default function TestLockoutModal({ isOpen, testAttemptId, onContactTeacher, onUnlockSuccess }: TestLockoutModalProps) {
