...
class TestAssignment(Base):
    ...
    # Selected lectures (array of UMALecture assignment IDs)
    selected_lecture_ids = Column(ARRAY(UUID(as_uuid=True)), nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint('array_length(selected_lecture_ids, 1) > 0', name='check_valid_lecture_ids'),
